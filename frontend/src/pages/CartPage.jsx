      ...
      <div className={`min-h-screen py-8 ${
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="animate-pulse">
            <div className={`h-8 rounded w-1/4 mb-8 ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-4">
              {items.map((item) => (
                <div 
                  key={item.id} 
                  className={`rounded-xl shadow-md p-6 border hover:shadow-lg transition-shadow duration-200 ${
                    isDark 
            ...
            <div className="lg:col-span-1">
              <div className={`rounded-xl shadow-md p-6 border sticky top-24 ${
                ...
                <Link
                  to="/"
                  className={`block text-center mt-4 hover:underline transition-colors duration-200 ${
                    isDark ? 'text-blue-400' : 'text-blue-600'
                  }`}
                >
                  Continue Shopping
